...
class CustomerPage(BasePage):
    ...
    _selected_delete_button = {"by": By.CSS_SELECTOR, "value": "#deleteAll"}
    ...
    def is_email_deleted(self, email):
    ...
    def delete_checked_data(self):

        self._click(self._selected_delete_button)
        Alert(self.driver).accept()
        self.is_customers_page()
        return True
    ...
    def get_checkbox_and_click(self, email):
        ...
        for tr in _tbody.find_elements(By.TAG_NAME, "tr"):
            td = tr.find_elements(By.TAG_NAME, "td")
            if td[4].text == email:
                td[0].find_element(by=By.CSS_SELECTOR, value=".checkboxcls").click()
