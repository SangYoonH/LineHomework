...
def test_valid_edit_customer(edit):
    ...
    edit.edit_data(config.edit_first_name, config.edit_last_name, config.edit_valid_email_address,
                   config.edit_valid_new_password, config.edit_mobile_number, config.edit_country, config.edit_address_1,
                   config.edit_address_2, config.edit_setting_status, config.edit_setting_currency, config.edit_setting_balance)
    assert edit.alert_danger_message_not_present()
    assert edit.is_customers_page()
